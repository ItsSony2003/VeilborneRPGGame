...
public class UI : MonoBehaviour
{
    ...
    #region UI Component Refernences
    ...
    public void ToggleSkillTreeUI()
    {
        ...
        screenEffectUI.transform.SetAsLastSibling();
    ...
    public void OpenShopUI(bool openShopUI)
    {
        shopUI.gameObject.SetActive(openShopUI);
        StopPlayerControls(openShopUI);
