...
public class UI_StatToolTip : UI_ToolTip
{
    ...
    public void ShowToolTip(bool slow, RectTransform rect, StatType statType)
    {
        base.ShowToolTip(slow, rect);
        statToolTipText.text = GetStatText(statType);
    }

    public string GetStatText(StatType type)
    {
        switch (type)
        {
            // Major Attributes
